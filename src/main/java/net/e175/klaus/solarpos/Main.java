...
@CommandLine.Command(name = "solarpos-cli", subcommands = {PositionCommand.class, SunriseCommand.class}, mixinStandardHelpOptions = true, description = "Calculates topocentric solar coordinates or sunrise/sunset times.")
public class Main {
 ...
 */
class DateTimeConsumer implements CommandLine.IParameterConsumer {
